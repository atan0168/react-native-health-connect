...
class ReactMindfulnessSessionRecord : ReactHealthRecordImpl<MindfulnessSessionRecord> {
  ...
  override fun getAggregateRequest(record: ReadableMap): AggregateRequest = throw AggregationNotSupported()

  override fun getAggregateGroupByDurationRequest(record: ReadableMap): AggregateGroupByDurationRequest = throw AggregationNotSupported()

  override fun getAggregateGroupByPeriodRequest(record: ReadableMap): AggregateGroupByPeriodRequest = throw AggregationNotSupported()

  override fun parseAggregationResult(record: AggregationResult): WritableNativeMap = throw AggregationNotSupported()
